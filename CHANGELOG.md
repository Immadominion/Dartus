...
### Changed
- Upload methods now default `deletable` to `true` when not specified
- Pass `deletable: false` explicitly to create permanent (non-deletable) blobs

## [0.1.0] - 2025-11-26

### Added
- Initial release with full Walrus API parity
- Upload methods: `putBlob`, `putBlobFromFile`, `putBlobStreaming`
